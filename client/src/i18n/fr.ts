...
export const fr: Translations = {
  ...
  catchBannerYou: "Vous n'avez pas annoncé LOCO !",
  ...
  reconnectingGame: 'Récupération de votre place…',
  reconnectingRoom: 'Retour dans le salon…',
  reconnectingHint: 'Votre main et votre score sont conservés une minute sur le serveur après une déconnexion.',
  reconnectingHintRoom: "La partie n'a pas encore commencé, rien n'est perdu.",
  ...
  rules: [
    ...
    },
    {
      ...
      items: [
        ...
        'Contre-LOCO est un pari : il ne compte que pendant ces 5 secondes, et un appel qui arrive après le LOCO ! coûte 1 carte à celui qui le lance.',
      ],
    },
    {
  ...
  errors: {
    ...
    reconnectFailed: 'Impossible de récupérer votre place. La partie est peut-être terminée.',
  },
}
