...
export const fr: Translations = {
  ...
  globalSwitchNoticeCw: '%actor lance la Rotation. Les mains glissent d\'un siège, sens horaire',
  globalSwitchNoticeCcw: '%actor lance la Rotation. Les mains glissent d\'un siège, sens antihoraire',
