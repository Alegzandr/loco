...
import Inspector from './I18nInspector.svelte'
import { en } from '../i18n/en'
import { fr } from '../i18n/fr'

// The component that exposes the language module's answers as DOM is
// `I18nInspector.svelte`: a Svelte component has to be its own file.
