...
export const TABLES: PageDef = {
  ...
  // The page is about the six places, not about the seats sharing a code, and
  ...
  description: {
    ...
    fr: 'Chaque partie se joue dans un décor, à une heure, sous un ciel : toits de néon, place de village, hôtel art déco, base lunaire, village thermal, port.',
  },
}
